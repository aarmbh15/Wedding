  ...
  return (
    ...
    >
      ...
      <div className="text-left mt-6">
        <p
          className={`font-cormorant text-[1.15rem] font-normal text-[#1a1a1a] mb-1 leading-tight transition-colors duration-300 ${
            hovered ? "text-[#c9a84c]" : ""
          }`}
        >
          {film.couple}
        ...
        <div className="flex items-center gap-3 mt-3">
          <span className="font-jost text-[0.7rem] font-medium tracking-[0.2em] uppercase text-[#999]">
            {film.location}
          </span>
